...
#
# The Terraform state for this module contains the service principal's
# CLIENT SECRET (when create_secret = true). Treat the state like a password:
#
...
#   backend "s3" {
#     bucket = "<your-terraform-state-bucket>"
#     key    = "cielara-prepare/aks/terraform.tfstate"
